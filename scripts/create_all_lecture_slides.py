...
def create_week2_slides():
    ...
    create_content_slide(prs, "Few-Shot Prompting", [
    ...
    create_content_slide(prs, "When to Use Few-Shot", [
        "Best For:",
    ...
    create_content_slide(prs, "Chain-of-Thought Prompting", [
    ...
    create_content_slide(prs, "CoT Example", [
        "Without CoT:",
    ...
    create_content_slide(prs, "Self-Ask for Decomposition", [
    ...
    create_content_slide(prs, "Combining Techniques", [
...
def create_week3_slides():
    ...
    create_content_slide(prs, "Least-to-Most (LtM)", [
    ...
    create_content_slide(prs, "Plan-and-Solve Approach", [
    ...
    create_content_slide(prs, "Self-Refine for Quality", [
    ...
    create_content_slide(prs, "Chain-of-Verification (CoVe)", [
    ...
    create_content_slide(prs, "Comparison Table", [
...
def create_week4_slides():
    ...
    create_content_slide(prs, "The RAG Problem", [
    ...
    create_content_slide(prs, "How RAG Works", [
    ...
    create_content_slide(prs, "RAG vs Fine-Tuning", [
        "When to use each:",
        "",
        "RAG:",
    ...
    create_content_slide(prs, "Embeddings Explained", [
    ...
    create_content_slide(prs, "Popular Vector Databases", [
        "Production Options:",
        "",
        "Pinecone:",
    ...
    create_content_slide(prs, "Prompt Chaining Concept", [
    ...
    create_content_slide(prs, "Production RAG + Chaining", [
...
def create_week5_slides():
    ...
    create_content_slide(prs, "The Evaluation Problem", [
    ...
    create_content_slide(prs, "Evaluation Dimensions", [
    ...
    create_content_slide(prs, "BLEU Score", [
    ...
    create_content_slide(prs, "ROUGE Score", [
    ...
    create_content_slide(prs, "F1 Score & Accuracy", [
    ...
    create_content_slide(prs, "Human Evaluation Framework", [
    ...
    create_content_slide(prs, "LLM-as-Judge", [
    ...
    create_content_slide(prs, "Bias Detection", [
        "Types of Bias:",
        "",
        "Gender Bias:",
...
def create_remaining_slides():
    ...
    create_content_slide(prs, "Why Multiple Agents?", [
    ...
    create_content_slide(prs, "MAS Architectures", [
        "Common Patterns:",
        "",
        "1. Sequential:",
    ...
    create_content_slide(prs, "Case Study: Microsoft AutoGen", [
    ...
    prs.slide_width = Inches(10)
    prs.slide_height = Inches(7.5)
    create_title_slide(prs, "Week 8: Agentic Business Applications", "MBA 590 - Case Studies & Implementation")
    create_content_slide(prs, "Key Topics", [
    ...
    create_section_slide(prs, "Questions & Discussion")
    prs.save('/home/user/data-advanced-ai/slides/Week08_Agentic_Business_Applications.pptx')
    ...
    for week_num, title, subtitle in [
        ...
        create_section_slide(prs, "Questions & Discussion")
        prs.save(f'/home/user/data-advanced-ai/slides/Week{week_num:02d}_{title.split(":")[1].strip().replace(" ", "_").replace("/", "_")}.pptx')
