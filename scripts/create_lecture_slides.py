...
def create_week1_slides():
    ...
    create_content_slide(prs, "Prompt Engineering Defined", [
    ...
    create_content_slide(prs, "Why It Matters for Business", [
    ...
    create_content_slide(prs, "Zero-Shot Prompts", [
    ...
    create_content_slide(prs, "Zero-Shot: Pros & Cons", [
        "Strengths:",
    ...
    create_content_slide(prs, "Role-Playing Prompts", [
    ...
    create_content_slide(prs, "Role-Playing: When to Use", [
        "Best For:",
    ...
    create_content_slide(prs, "Detailed Instruction Prompts", [
    ...
    create_content_slide(prs, "Detailed Instructions: Components", [
        "Template Structure:",
        "",
    ...
    create_content_slide(prs, "Cost-Benefit Analysis", [
    ...
    create_content_slide(prs, "Decision Matrix", [
    ...
    create_content_slide(prs, "10 Prompt Engineering Principles", [
    ...
    create_content_slide(prs, "Real-World Business Applications", [
        "Customer Service:",
    ...
    # ROI Example
    create_content_slide(prs, "ROI Example: Customer Service", [
    ...
    # Hands-On Exercise
    create_content_slide(prs, "Hands-On Exercise", [
...
def create_week6_slides():
    ...
    create_content_slide(prs, "Agentic Systems Defined", [
    ...
    create_content_slide(prs, "The 6 Characteristics", [
    ...
    create_content_slide(prs, "Key Differences", [
        "Automation:",
    ...
    create_content_slide(prs, "Decision Framework", [
    ...
    create_content_slide(prs, "The Perception-Action Loop", [
    ...
    create_content_slide(prs, "Agent Memory Types", [
        "How agents remember:",
        "",
    ...
    create_content_slide(prs, "ReAct: Reasoning + Acting", [
    ...
    create_content_slide(prs, "ReAct Performance Gains", [
    ...
    create_content_slide(prs, "ReAct Example", [
    ...
    create_content_slide(prs, "7 Levels of Agent Complexity", [
    ...
    create_content_slide(prs, "Architecture Selection Guide", [
    ...
    create_content_slide(prs, "Case Study: Klarna Customer Service", [
    ...
    create_content_slide(prs, "Case Study: Morgan Stanley", [
    ...
    create_content_slide(prs, "When Agentic Capabilities Add Value", [
        "Best Use Cases:",
        "",
    ...
    # ROI Framework
    create_content_slide(prs, "ROI Calculation Framework", [
        "Costs:",
...
def create_week13_slides():
    ...
    create_content_slide(prs, "Technology Adoption Lifecycle", [
    ...
    create_content_slide(prs, "Technology Assessment Matrix", [
    ...
    create_content_slide(prs, "Weighted Scoring Model", [
    ...
    create_content_slide(prs, "RICE Framework (Alternative)", [
    ...
    create_content_slide(prs, "Strategic Impact vs Difficulty Matrix", [
    ...
    create_content_slide(prs, "The Three Horizons Model", [
    ...
    create_content_slide(prs, "Portfolio Balance Dimensions", [
    ...
    create_content_slide(prs, "Portfolio Health Metrics", [
    ...
    create_content_slide(prs, "5-Factor Assessment Model", [
    ...
    create_content_slide(prs, "Case Study: Netflix Technology Strategy", [
    ...
    create_content_slide(prs, "Netflix: Build vs Buy Decisions", [
        "Strategic Choices:",
        "",
        "BUILD:",
    ...
    create_content_slide(prs, "Case Study: Capital One AI-First Strategy", [
    ...
    create_content_slide(prs, "Case Study: John Deere Platform Strategy", [
    ...
    create_content_slide(prs, "Roadmap Components", [
        "NOW (0-6 months):",
    ...
    create_content_slide(prs, "Roadmap Principles", [
